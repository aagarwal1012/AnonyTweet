...
public class MyTweets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circular_progress = findViewById(R.id.circular_progress_mytweets);

        // Adding Toolbar to Main screen
        Toolbar toolbar = findViewById(R.id.toolbar_mytweets);
        ...
        //setup Recycler view
        recycle = findViewById(R.id.my_recycler_view_mytweets);
        addEventFirebaseListener();

        //Refresh Layout
        refreshLayout = findViewById(R.id.swipe_refresh_mytweets);
